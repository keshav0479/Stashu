  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8">
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        <div className="inline-block mb-3 px-4 py-1.5 rounded-full border border-[var(--color-border)] bg-[var(--color-bg-glass)] backdrop-blur-md">
          <span className="text-xs font-medium text-[var(--color-accent-primary)] tracking-wider uppercase">V 1.0 • Alpha</span>
        </div>

        <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 tracking-tight">
          Stash<span className="text-[var(--color-accent-primary)]">u</span>
        </h1>
        <p className="text-xl text-[var(--color-text-secondary)] max-w-lg mx-auto leading-relaxed font-light">
          The <span className="text-[var(--color-text-primary)] font-medium">blind vending machine</span> for the sovereign web.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8 w-full max-w-4xl relative z-10 px-4">
        ...
        <div className="glass-card p-10 flex-1 text-center hover:scale-[1.02] transition-transform group">
          <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-orange-500/20 to-orange-500/5 rounded-2xl flex items-center justify-center border border-orange-500/20 group-hover:border-orange-500/40 transition-colors">
        ...
        {/* Buyer Card */}
        <div className="glass-card p-10 flex-1 text-center hover:scale-[1.02] transition-transform group">
          <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-indigo-500/20 to-indigo-500/5 rounded-2xl flex items-center justify-center border border-indigo-500/20 group-hover:border-indigo-500/40 transition-colors">
            <span className="text-3xl">🔓</span>
          </div>
